  ...
  return (
    <div className="p-4 md:p-6 space-y-6">
      ...
      <div className="bg-primary text-white p-6 rounded-2xl shadow-lg">
        <Typography variant="small" className="opacity-90 mb-1">Available Balance</Typography>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-white p-4 rounded-xl border border-gray-200">
          <Typography variant="small" color="muted">This Week</Typography>
          <Typography variant="h3" weight="bold">₹4,500</Typography>
        </div>
        <div className="bg-white p-4 rounded-xl border border-gray-200">
          <Typography variant="small" color="muted">Total Trips</Typography>
            ...
            <div key={i} className="p-4 flex justify-between items-center">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <Typography variant="small" color="muted">Oct 2{i}, 2023</Typography>
                </div>
              </div>
